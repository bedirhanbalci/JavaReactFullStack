...
public interface LocationRepository extends JpaRepository<Location, Integer> {
    ...
    List<GetListLocationResponse> findByOrderByPickUp();

    boolean existsLocationByPickUpLocationStartingWith(String pickUpLocation);

    boolean existsByDropOffLocationEndingWith(String dropOffLocation);
