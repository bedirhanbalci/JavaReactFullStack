...
public class IndividualsController {
    ...
    @PostMapping
    public void add(@RequestBody @Valid AddIndividualRequest addIndividualRequest) {
    ...
    @PutMapping
    public void update(@RequestBody @Valid UpdateIndividualRequest updateIndividualRequest) {
